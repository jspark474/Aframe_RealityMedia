    ...
    tick() {
      ...
      for (const inputSource of session.inputSources) {
        ...
        if (magnetEl) {
          ...
          const magnetTargets = Array.from(document.querySelectorAll(magnetEl.dataset.magnet)).sort((a,b)=>Number(a.dataset.magnetPriority || 1)-Number(b.dataset.magnetPriority || 1));
